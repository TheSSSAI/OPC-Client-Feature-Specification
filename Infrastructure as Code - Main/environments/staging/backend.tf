# This file configures the remote state backend for the Staging environment.
...
terraform {
  backend "s3" {
    ...
    bucket = "industrial-iot-platform-tfstate-staging"
    ...
    dynamodb_table = "industrial-iot-platform-tfstate-lock-staging"
